...
<html>
    ...
    <body>
        ...
        <form method="post" action="RegisterServlet" style="text-align: center;">
            ...
            <input id="email" name="email"  type="email" placeholder="<%=(emailErr != null ? emailErr : "Enter Email")%>" required = "true"/>
            <label for="password">Password</label>
            <input id="password" name="password" type="password" placeholder="<%=(passErr != null? passErr : "Enter Password")%>" required = "true"/>
