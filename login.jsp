...
<html>
    ...
    <body>
        ...
        <form style="text-align: center;" method="post" action="LoginServlet">
            ...
            <input id="email" type="email" name="email" placeholder="<%=(emailErr != null ? emailErr : "Email Address")%>"/>
            <label for="password">Password</label>
            <input id="password" type="password" name="password" placeholder="<%=(passwordErr != null ? passwordErr : "Password")%>"/>
